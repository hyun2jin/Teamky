...
public class CommentExModel {
	
	private int	comment_num;
	private int	comment_board;
	private int comment_commnum;
	...
	public int getComment_commnum() {
		return comment_commnum;
	}
	public void setComment_commnum(int comment_commnum) {
		this.comment_commnum = comment_commnum;
	}
